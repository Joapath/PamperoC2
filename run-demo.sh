...
echo "  POST   /api/v1/agents/beacon              - Beacon de agente"
echo "  GET    /api/v1/agents                     - Listar agentes"
echo "  GET    /api/v1/agents/{id}                - Obtener agente"
echo "  POST   /api/v1/agents/{id}/jobs           - Crear job"
echo "  GET    /api/v1/agents/{id}/jobs           - Listar jobs"
echo "  POST   /api/v1/jobs/{id}/results          - Enviar resultado"
